  ...
  roles: [
    {
      ...
      bullets: [
        ...
        'Design MySQL schemas and data models for procurement, budget, and asset lifecycle data, including purchase-order relationships, depreciation that feeds current net book value, and Excel import of legacy asset records.',
        ...
        'Build from scratch: Vendor, Indent, Purchase Order, Delivery, Invoice, Vouchers, Budget, Asset Management, Escort, and ID Cards. Contribute features to Examination, Student Tasks, Visitor, Item Catalog, Sales, Staff Allocation, Reporting, Gallery, and Assessment for Learning.',
      ],
    },
  ],
};
